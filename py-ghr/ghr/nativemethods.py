...
import ctypes
from ctypes import c_void_p, c_int, POINTER, c_float, c_ulong, Structure, c_double
...
def __init_optimizer():
    ...
    GHR_DLL.GHR_LM.argtypes = [c_void_p, POINTER(c_float), POINTER(c_double), c_ulong, c_double]
